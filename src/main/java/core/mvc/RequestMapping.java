...
import next.controller.qna.UpdateQuestionConfirmController;
...
public class RequestMapping {
    ...
    void initMapping() {
        ...
        mappings.put("/qna/update/form", new UpdateQuestionFormController());
        mappings.put("/qna/update", new UpdateQuestionController());

        mappings.put("/api/qna/deleteQuestion", new DeleteQuestionController());
        mappings.put("/api/qna/update/confirm", new UpdateQuestionConfirmController());
