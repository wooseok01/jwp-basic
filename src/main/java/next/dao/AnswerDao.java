...
public class AnswerDao {
	...
	public Integer findAnswerByWriter(long questionId, String writer) {
		String sql = "SELECT COUNT(*) AS count FROM ANSWERS WHERE questionId = ? AND writer = ?";
		...
		return jdbcTemplate.query(sql, rm, questionId, writer).get(0);
	}
}
